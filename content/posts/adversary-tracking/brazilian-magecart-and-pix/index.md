...
- Implement CSP and SRI. Content Security Policy restricts which domains a page can load scripts from or send data to, blocking unauthorized exfiltration endpoints such as Discord webhooks. Subresource Integrity ensures loaded third-party scripts haven't been tampered with.
